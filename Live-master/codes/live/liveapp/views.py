...
def ffmpeg(id):
    ...
    os.system(
         'ffmpeg.exe '
         '-thread_queue_size 128 -rtbufsize 1000M'
        '-f dshow -i video="'
           +get_video_name()+
            '"  '
            '-f dshow -i audio="'
    ...
    os.system(
        'ffmpeg -f dshow -i audio="麦克风阵列 (Realtek High Definition Audio)" -re -i mouse.mp4 -vcodec copy -f flv rtmp://localhost:1935/live/'+id)
        #'ffmpeg -f dshow -i video="HP Wide Vision HD" -vcodec libx264 -acodec copy -preset:v ultrafast -tune:v zerolatency -f flv rtmp://eguid.cc:1935/rtmp/eguid -f flv rtmp://localhost:1935/live/'+id)
         #'ffmpeg.exe -thread_queue_size 128 -rtbufsize 1000M -f dshow -i video="HP Wide Vision HD" -f dshow -i audio="麦克风阵列 (Realtek High Definition Audio)" -vcodec libx264 -preset:v ultrafast -tune:v zerolatency -f flv rtmp://localhost:1935/live/'+id)
    #os.system(
    #    'ffplay -s 320*240 -f dshow -i video="HP Wide Vision HD"')

    #os.system(
    #    'ffmpeg -f dshow -i video="HP Wide Vision HD" -f dshow -i audio="麦克风阵列 (Realtek High Definition Audio)" -s 800x600 -r 10 -vcodec libx264 -preset:v ultrafast -tune:v zerolatency -f flv rtmp://localhost:1935/live/1293636441140526?vdoid=2019-04-19')

    #os.system(
        #'ffmpeg -rtbufsize 1000M -f dshow -i   video="HP Wide Vision HD":audio="virtual-audio-capturer" -vcodec libx264  -preset veryfast -crf 22 -tune:v zerolatency -crf 22 -f flv rtmp://localhost:1935/live/'
        #'ffmpeg -rtbufsize 1000M -f dshow -i video="screen-capture-recorder" -f dshow -i audio="麦克风阵列 (Realtek High Definition Audio)" -vcodec libx264 -acodec copy -preset:v ultrafast -tune:v zerolatency -f flv rtmp://localhost:1935/live/'
        
        #'ffmpeg -thread_queue_size 128 -rtbufsize 1000M -f dshow -i video="HP Wide Vision HD" -f dshow -i audio="麦克风阵列 (Realtek High Definition Audio)" -vcodec libx264 -acodec copy -preset:v ultrafast -tune:v zerolatency -f flv rtmp://localhost:1935/live/'
    #)
